# Migration `20210506103934-add-profile`

This migration has been generated by Jussi at 5/6/2021, 1:39:34 PM.
...
CREATE UNIQUE INDEX "profiles_uid_unique" ON "profiles"("uid")

ALTER TABLE "profiles" ADD FOREIGN KEY("uid")REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE
```
