...
export class NumberExpression extends Expression {
  ...
  static is(val: unknown): val is NumberExpression {
...
export class ParenthesisExpression extends Expression {
  ...
  static is(val: unknown): val is ParenthesisExpression {
    return val instanceof ParenthesisExpression;
  }

  static isOpening(val: unknown): val is ParenthesisExpression {
    return val instanceof ParenthesisExpression && val.isOpening();
  }

  static isClosing(val: unknown): val is ParenthesisExpression {
...
export class OperatorExpression extends Expression {
  ...
  evaluate(a: Big | NumberExpression, b: Big | NumberExpression) {
    const _a = NumberExpression.is(a) ? a.value : a;
    const _b = NumberExpression.is(b) ? b.value : b;
    switch (this.value) {
      case "+":
  ...
  static is(val: unknown): val is OperatorExpression {
    return val instanceof OperatorExpression;
  }

  static isAddition(val: unknown): val is OperatorExpression {
    return val instanceof OperatorExpression && val.value === "+";
  }

  static isSubtraction(val: unknown): val is OperatorExpression {
    return val instanceof OperatorExpression && val.value === "-";
  }

  static isMultiplication(val: unknown): val is OperatorExpression {
    return val instanceof OperatorExpression && val.value === "*";
  }

  static isDivision(val: unknown): val is OperatorExpression {
    return val instanceof OperatorExpression && val.value === "/";
  }
