...
export function SidebarUser(props: SidebarUserProps) {
	...
	return <Link href={pages.settings.account}>
		<a className={c("bg-transparent group relative w-full px-4 py-4 inline-flex items-center gap-4 rounded hover:bg-slate-200 dark:hover:bg-slate-840 transition-colors duration-100")}>
			<motion.span
				initial={false}
				animate={{
